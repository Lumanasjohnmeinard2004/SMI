...
const COMPANY_FILTERS = [
  ...
  { key: "company1", label: "Company 1" },

  { key: "company2", label: "Company 2" },

  { key: "company3", label: "Company 3" },

  { key: "company4", label: "Company 4" },
...
function normalizeCompany(value) {
  ...
  if (["company1", "comp1", "1"].includes(cleaned)) return "company1";

  if (["company2", "comp2", "2"].includes(cleaned)) return "company2";

  if (["company3", "comp3", "3"].includes(cleaned)) return "company3";

  if (["company4", "comp4", "4"].includes(cleaned)) return "company4";
...
function formatCompany(value) {
  ...
  if (normalized === "company1") return "Company 1";

  if (normalized === "company2") return "Company 2";

  if (normalized === "company3") return "Company 3";

  if (normalized === "company4") return "Company 4";
...
function ManualContent({
  ...
  const filteredMembers = useMemo(() => {
    ...
    return members.filter(
      ...
      (member) => normalizeCompany(member.company) === selectedCompany
  ...
  return (
    ...
    <View>
      ...
      <View style={styles.panelCard}>
        ...
        <View style={styles.companyFilterSection}>

          <Text style={styles.companyFilterLabel}>Filter members by company</Text>
          ...
          <ScrollView
            ...
            contentContainerStyle={styles.companyFilterRow}

          >

            {COMPANY_FILTERS.map((option) => {

              const active = selectedCompany === option.key;
              ...
              return (
                ...
                <TouchableOpacity
                  ...
                  style={active ? styles.companyFilterActive : styles.companyFilterButton}

                  onPress={() => setSelectedCompany(option.key)}
                  ...
                  <Text
                    ...
                    style={
                      ...
                      active
                        ...
                        ? styles.companyFilterTextActive
        ...
        <View style={styles.memberHintBox}>
          ...
          <View style={styles.memberHintHeader}>
          ...
          {loadingMembers ? (
            ...
            <Text style={styles.memberHintText}>
              ...
              No members found under {

                selectedCompany === "all"

                  ? "the selected filter"

                  : formatCompany(selectedCompany)
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              ...
              {filteredMembers.map((member) => (
                ...
                >
                  ...
                  <Text style={styles.memberChipCompany}>

                    {formatCompany(member.company)}
